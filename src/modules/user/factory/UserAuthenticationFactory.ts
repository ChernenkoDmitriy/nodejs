...
import { FindUsersUseCase } from "../useCases/findUsersUseCase/FindUsersUseCase";
...
export class UserAuthenticationFactory {
    ...
    private createPresenter = () => {
        ...
        const findUsersUseCase = new FindUsersUseCase(userHelper, userPersistance);
        ...
        const userController = new UserController(userRegisterUseCase, userAuthorizationUseCase, findUsersUseCase);
